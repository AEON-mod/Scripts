...
echo "You can now bind the following in your Hyprland config:"
echo "  - Super+Shift+Ctrl+S: takeshot output (entire screen)"
echo "  - Super+Shift+S: takeshot window"
echo "  - Super+Ctrl+S: takeshot region"
echo -e "${BLUE}Remember to use 'bindr' (or '{ release = true }' in Lua) for window and region captures!${NC}"
